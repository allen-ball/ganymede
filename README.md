...
```bash
$ java -jar ganymede-2.0.3.20221217.jar -i
```
...
[Ganymede Kernel download]: https://github.com/allen-ball/ganymede/releases/download/v2.0.3.20221217/ganymede-2.0.3.20221217.jar
